...
tests/libtest/CMakeFiles/hostname.dir/sethostname.c.o: ../tests/libtest/sethostname.c
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/curl/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building C object tests/libtest/CMakeFiles/hostname.dir/sethostname.c.o"
	cd /tmp/curl/build/tests/libtest && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -o CMakeFiles/hostname.dir/sethostname.c.o   -c /tmp/curl/tests/libtest/sethostname.c
...
tests/libtest/CMakeFiles/hostname.dir/sethostname.c.i: cmake_force
	...
	cd /tmp/curl/build/tests/libtest && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E /tmp/curl/tests/libtest/sethostname.c > CMakeFiles/hostname.dir/sethostname.c.i
...
tests/libtest/CMakeFiles/hostname.dir/sethostname.c.s: cmake_force
	...
	cd /tmp/curl/build/tests/libtest && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S /tmp/curl/tests/libtest/sethostname.c -o CMakeFiles/hostname.dir/sethostname.c.s
...
tests/libtest/.libs/libhostname.so: tests/libtest/CMakeFiles/hostname.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/curl/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking C shared module .libs/libhostname.so"
	cd /tmp/curl/build/tests/libtest && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/hostname.dir/link.txt --verbose=$(VERBOSE)
...
tests/libtest/CMakeFiles/hostname.dir/clean:
	cd /tmp/curl/build/tests/libtest && $(CMAKE_COMMAND) -P CMakeFiles/hostname.dir/cmake_clean.cmake
.PHONY : tests/libtest/CMakeFiles/hostname.dir/clean

tests/libtest/CMakeFiles/hostname.dir/depend:
	cd /tmp/curl/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/curl /tmp/curl/tests/libtest /tmp/curl/build /tmp/curl/build/tests/libtest /tmp/curl/build/tests/libtest/CMakeFiles/hostname.dir/DependInfo.cmake --color=$(COLOR)
