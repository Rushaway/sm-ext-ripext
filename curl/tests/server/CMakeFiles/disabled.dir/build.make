...
tests/server/CMakeFiles/disabled.dir/disabled.c.o: ../tests/server/disabled.c
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/tmp/curl/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building C object tests/server/CMakeFiles/disabled.dir/disabled.c.o"
	cd /tmp/curl/build/tests/server && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -o CMakeFiles/disabled.dir/disabled.c.o   -c /tmp/curl/tests/server/disabled.c
...
tests/server/CMakeFiles/disabled.dir/disabled.c.i: cmake_force
	...
	cd /tmp/curl/build/tests/server && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -E /tmp/curl/tests/server/disabled.c > CMakeFiles/disabled.dir/disabled.c.i
...
tests/server/CMakeFiles/disabled.dir/disabled.c.s: cmake_force
	...
	cd /tmp/curl/build/tests/server && /usr/bin/cc $(C_DEFINES) $(C_INCLUDES) $(C_FLAGS) -S /tmp/curl/tests/server/disabled.c -o CMakeFiles/disabled.dir/disabled.c.s
...
tests/server/disabled: tests/server/CMakeFiles/disabled.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/tmp/curl/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking C executable disabled"
	cd /tmp/curl/build/tests/server && $(CMAKE_COMMAND) -E cmake_link_script CMakeFiles/disabled.dir/link.txt --verbose=$(VERBOSE)
...
tests/server/CMakeFiles/disabled.dir/clean:
	cd /tmp/curl/build/tests/server && $(CMAKE_COMMAND) -P CMakeFiles/disabled.dir/cmake_clean.cmake
.PHONY : tests/server/CMakeFiles/disabled.dir/clean

tests/server/CMakeFiles/disabled.dir/depend:
	cd /tmp/curl/build && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /tmp/curl /tmp/curl/tests/server /tmp/curl/build /tmp/curl/build/tests/server /tmp/curl/build/tests/server/CMakeFiles/disabled.dir/DependInfo.cmake --color=$(COLOR)
